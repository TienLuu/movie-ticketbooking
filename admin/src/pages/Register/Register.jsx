...
const Register = () => {
   ...
   const onSubmit = async (values) => {
      registerRequest
         .runAsync({
            ...values,
            hoTen: values.fisrtName + " " + values.lastName,
         })
         .then(() => {
            ...
            <div className={styles.container}>
               ...
               <form onSubmit={handleSubmit(onSubmit)} className={styles.form}>
                  ...
                  <TextField
                     ...
                     {...register("email", {
                        ...
                        pattern: {
                           ...
                           message:
                              "Your email is not match format xxx@xxx.xxx",
                        },
                     })}
                  ...
                  <div className={styles.control}>
                     <div className={styles.accept}>
                        ...
                        <label htmlFor={styles.accept}>
                           I agree with
                           <Link to="/contract-lience" className={styles.link}>
                              Terms & Conditions
                           </Link>
                           and have understood
                  ...
                  {registerRequest.error && (
                     <p className={styles.errorMess}>{registerRequest.error}</p>
                  )}
                  <Button
                     solid
                     primary
