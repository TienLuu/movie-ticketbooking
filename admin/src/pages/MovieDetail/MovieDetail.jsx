...
const MovieDetail = () => {
   ...
   return (
      <div className={styles.wrapper}>
               ...
               <Box className={styles.container}>
                  ...
                  <Grid container spacing={2}>
                     ...
                     <Button
                        ...
                        onClick={() =>
                           setIsOpenScheduleForm(!isOpenScheduleForm)
                        }
                     >
                        Schedule
                     </Button>
         ...
         <MovieEditFormModal
            open={isOpenEditForm}
            onClose={() => setIsOpenEditForm(!isOpenEditForm)}
         />
         {/******** Movie Schedule modal ***********/}
         <MovieScheduleFormModal
            open={isOpenScheduleForm}
            onClose={() => setIsOpenScheduleForm(!isOpenScheduleForm)}
         />
      </div>
   );
};
