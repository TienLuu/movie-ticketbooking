...
const MovieScheduleFormModal = ({ open = false, onClose }) => {
   ...
   const createSchedule = useRequest(ticketAPI.createSchedule, {
      manual: true,
   });
   ...
   const handleSelectTheaterGroup = () => {
      ...
      const theaterGroup = getTheaters.data?.find(
         (item) => item.maCumRap === theaterGroupID
      );
                     ...
                     <Controller
                        ...
                        render={({ field }) => (
                           <StyledSelect
                              formRegister={field}
                              label="Theater ID"
                              options={selectedTheaterGroup.danhSachRap?.map(
                                 (item) => ({
                                    label: item.tenRap,
                                    value: item.maRap,
                                 })
